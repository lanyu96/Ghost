 ...
 * @Description:
 */
public class WeanRecord extends BaseRecord {
    private String field_name;
    private String createTime;
    private String MPK_pigfen_name;
    ...
    public void setMPK_pigfen_name(String MPK_pigfen_name) {
        this.MPK_pigfen_name = MPK_pigfen_name;
    }
    ...
    public String getMPK_pigfen_name() {
        return MPK_pigfen_name;
    }
