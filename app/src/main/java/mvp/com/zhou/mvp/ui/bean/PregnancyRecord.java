 ...
 * @Description:
 */
public class PregnancyRecord extends BaseRecord{
    ...
    private String abort_name;
    private String batch_id;
    private String sowno_number;
    private String sowno_id;
    ...
    public String getSowno_id() {
        return sowno_id;
    }

    public void setSowno_id(String sowno_id) {
        this.sowno_id = sowno_id;
    }
    ...
    public void setBreeder_name(String breeder_name) {
        this.breeder_name = breeder_name;
    }

    public void setAbort_id(String abort_id) {
        this.abort_id = abort_id;
    }
    ...
    public void setTulnm(String tulnm) {
        this.tulnm = tulnm;
    }
    ...
    public void setAbort_name(String abort_name) {
        this.abort_name = abort_name;
    }
    ...
    public String getBreedingDate() {
        ...
        return BreedingDate.substring(0,10);
    }
