 ...
 * @Description:
 */
public class FarrowRecord extends BaseRecord{
    ...
    private String pk_pigstock_name;
    private String handler_name;
    private String idith;
    private String incnt;
    private String number;
    private String newPk_pigstock_name;
    ...
    public void setPk_pigstock_name(String pk_pigstock_name) {
        this.pk_pigstock_name = pk_pigstock_name;
    }
    ...
    public void setNewPk_pigstock_name(String newPk_pigstock_name) {
        this.newPk_pigstock_name = newPk_pigstock_name;
    }
    ...
    public void setBorIndno(String borIndno) {
        this.borIndno = borIndno;
    }
    ...
    public String getPk_pigstock_name() {
        return pk_pigstock_name;
    }
    ...
    public String getNewPk_pigstock_name() {
        return newPk_pigstock_name;
    }
    ...
    public String getServicedate() {
        ...
        return servicedate.substring(0,10);
    }
