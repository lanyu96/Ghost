package com.zhou.ghost.ui.adapter.dialog;
...
import com.zhou.ghost.ui.bean.BreedBatch;


/**
 * Created by zhou on 2018/4/3.
 */
public class SelectMaterielAdapter extends BaseAdapter {
    private Context mContext;
    private List<BreedBatch> mList;


    public SelectMaterielAdapter(Context context, List<BreedBatch> list) {
        mContext = context;
        mList = list;
    }
