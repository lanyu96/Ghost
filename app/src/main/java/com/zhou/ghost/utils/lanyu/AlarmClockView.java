...
public class AlarmClockView extends View {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (array != null) {
            mOuterCircleColor = array.getColor(R.styleable.AlarmClockView_outerCircleColor, getResources().getColor(R.color.gray_light));
            mInnerCircleColor = array.getColor(R.styleable.AlarmClockView_innerCircleColor, getResources().getColor(R.color.gray_deep));
